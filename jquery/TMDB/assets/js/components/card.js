function card(data) {
    return(
        ...
        <div class="card w-100" data-movie-title="${data.id} position-relative">
            <img src="${'https://image.tmdb.org/t/p/w500' + data.poster_path}" class="card-img-top img-fluid h-100" alt="${data.original_title}">
            <div class="card-body min-h-32 text-justify d-grid ">
